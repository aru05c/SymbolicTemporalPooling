...
class Mars(object):
    ...
    def __init__(self, root='/media/socialab/4C09C760503E353F/Datasets/MARS', min_seq_len=0):
...
class PRID2011(object):
    ...
    Args:
        ...
        min_seq_len (int): tracklet with length shorter than this value will be discarded (default: 0).
    """
    root = '/media/socialab/4C09C760503E353F/Datasets/PRID_Data/prid_2011'
    # root = './data/prid2011'
...
class PDESTRE(object):
    ...
    Args:
        ...
        min_seq_len (int): tracklet with length shorter than this value will be discarded (default: 0).
    """
    root = '/media/socialab/4C09C760503E353F/Extract_PIDS/'
    test_out_path = '/media/socialab/4C09C760503E353F/Datasets/P-Destre/method2'
    split_path = '/media/socialab/4C09C760503E353F/Datasets/P-Destre/New_Splits/'
    # split_path = osp.join(root, '/media/socialab/4C09C760503E353F/Datasets/P-Destre/splits_pdestra_up.json')
    # cam_a_path = osp.join(root, 'prid_2011', 'multi_shot', 'cam_a')
    # cam_b_path = osp.join(root, 'prid_2011', 'multi_shot', 'cam_b')
    split_id = 1
    max_splits = 5

    # Train_name=split_path+'Train_'+str(split_id)
    # with open(Train_name, 'r') as fid:
    #     lines = [line.strip() for line in fid.readlines()]
    #     train_dirs = lines[1:]
    # Query_name=split_path+'val_'+str(split_id)
    # with open(Query_name, 'r') as fid:
    #     lines = [line.strip() for line in fid.readlines()]
    #     query_dirs = lines[1:]
    # Test_name = split_path + 'val_' + str(split_id)
    # with open(Test_name, 'r') as fid:
    #     lines = [line.strip() for line in fid.readlines()]
    #     test_dirs = lines[1:]
    def __init__(self, split_id=0, min_seq_len=0):
        self._check_before_run()
...
class iLIDSVID(object):
    ...
    Args:
        split_id (int): indicates which split to use. There are totally 10 splits.
    """
    root = '/media/socialab/4C09C760503E353F/Datasets/iLIDS-VID/ilids-vid'
